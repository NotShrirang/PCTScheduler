    ...
    if generate_button:
        ...
        for day_counter in range(1, month_days+1):
            ...
            if current_day == "Tuesday":
                ...
                entry = TRAINING_GAMES.copy()
                entry.pop("GROUP 3 DATE")
                entry["GROUP 1 DATE"] = current_date + \
        ...
        fen_schedule1 = fen_schedule1[[
            "GROUP 1 DATE", "DAY", "TIME", "TITLE", "FEN"]]
        fen_schedule23 = fen_schedule23[[
            "GROUP 2 DATE", "GROUP 3 DATE", "DAY", "TIME", "TITLE", "FEN"]]
        fen_schedule23.columns = [
            "GROUP 2 DATE", "GROUP 3 DATE", "GROUP 3 DAY", "TIME", "TITLE", "FEN"]
        ...
        st.download_button("⬇️ Download Schedule", data=df_xlsx,
                           file_name="{}{} - FENs.xlsx".format(MONTH, year), mime="application/vnd.ms-excel")
